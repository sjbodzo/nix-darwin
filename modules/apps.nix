{ inputs, pkgs, ... }: {
  ...
  homebrew = {
    ...
    # brew install
    brews = [ "openconnect" "luarocks" "lua-language-server" "sqlcmd" "cargo-nextest" "helm" "sshpass" "semgrep" "cargo-binstall" "jj" "zarf" "uds" "azure-cli" "argocd" "tilt" "clusterawsadm" ];
